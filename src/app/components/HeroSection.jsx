    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold"><span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600'>Hello, I'm{""}</span><br /> <TypeAnimation sequence={[
            'Hanif',
            1000,
            'Web Developer',
            1000,
          ...
          <p className='text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl'>
            "Tiba-tiba, langit mendung dan hujan deras turun, menciptakan suasana yang benar-benar random."
          </p>
          <div>
